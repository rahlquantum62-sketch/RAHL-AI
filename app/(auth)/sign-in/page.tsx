  ...
  return (
    <div className="max-w-sm mx-auto py-16">
      ...
      <form onSubmit={submit} className="flex flex-col gap-3">
        ...
        <button className="mt-2 px-4 py-3 rounded-2xl bg-white text-black">Sign in</button>
        <p className="text-sm text-neutral-400">No account? <Link className="underline" href="/sign-up">Create one</Link></p>
      </form>
    </div>
  );
}
